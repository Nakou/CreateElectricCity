...
public class CECContinuousSound extends AbstractTickableSoundInstance {
    private final float sharedPitch;
    private final CECSoundScape soundScape;
    private final float relativeVolume;

    public CECContinuousSound(SoundEvent event, CECSoundScape soundScape, float sharedPitch, float relativeVolume) {
